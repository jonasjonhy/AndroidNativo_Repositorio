...
public class PessoaAdapter extends BaseAdapter {
    ...
    public PessoaAdapter(Context context, List<Pessoa> list){
    ...
    public View getView(int position, View arg1, ViewGroup arg2) {
        ...
        final LinearLayout layout = (LinearLayout) inflater.inflate(R.layout.pessoa, null);
